...
def load_db():
    if not os.path.exists(DB_FILE):
        default = {"user_pw": "dark870", "users": {}, "start_times": {}}
    ...
    with open(DB_FILE, "r") as f:
        try:
            ...
            if "user_pw" not in data: data["user_pw"] = "dark870"
            if "start_times" not in data: data["start_times"] = {}
            return data
        except:
            return {"user_pw": "dark870", "users": {}, "start_times": {}}
